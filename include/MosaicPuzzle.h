...
void RunMosaicPuzzle( string inputName, string outputImage, vector< string > inputDirectory, int numCells, bool secondPass, float renderScale, float buildScale, float angleOffset, float edgeWeight, bool smoothImage, bool skipNearby, float sizePower, bool recursiveSearch, string fileName );